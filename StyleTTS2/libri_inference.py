...
if __name__ == "__main__":
    ...
    ref_style = synthesiser.compute_style("Models/LibriTTS/woman1.wav")

    text = "Hello, how are you doing today? I am testing the new fine-tuned model with a reference style."
